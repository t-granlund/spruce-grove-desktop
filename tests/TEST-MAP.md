...
| Studio (recording library) | Takes append, transcripts edit in place, reorder, splice via ffmpeg, lock refuses further edits | `recordings.rs` unit tests (incl. real-audio splice); `test_desktop_ui.py` §14e |
